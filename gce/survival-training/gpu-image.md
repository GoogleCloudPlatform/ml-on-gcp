# Creating a custom GPU image for TensorFlow training

This documentation shows you how to set up a custom Compute Engine image that
you can use in your GPU-enabled [Compute Engine
VMs](https://cloud.google.com/compute/docs/gpus/add-gpus) when you want to make
the GPUs available to TensorFlow.

Any image you create as per these instructions is intended for personal use, and
your environment will not be accessible to other users on a VM containing the
image (unless they access it as superusers).
