...
def test_ncf_main(gcs_bucket_prefix, submit_script):
    ...
    assert 'timeline-1000.json' in out_str, 'Artifact "timeline-1000.json" not found in bucket {} with prefix {} after {} seconds.'.format(bucket, prefix, WAIT_TIME)
